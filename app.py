...
def pendu():
    ...
    return render_template("pendu/index.html", pendu_state=state, pseudo=session["pseudo"])
...
def spectateur(pseudo):
    return render_template('C4/spectateur.html', joueur=pseudo, pseudo=session['pseudo'])
